...
// .wrangler/tmp/pages-iI2eii/functionsWorker-0.3850268391472088.mjs
...
__name2(rowToProject, "rowToProject");
...
__name2(safeParseArray, "safeParseArray");
...
__name2(validateProject, "validateProject");
var COLUMNS = {
  title: /* @__PURE__ */ __name2((v) => v, "title"),
  slug: /* @__PURE__ */ __name2((v) => slugify(v), "slug"),
  domain: /* @__PURE__ */ __name2((v) => v, "domain"),
  location: /* @__PURE__ */ __name2((v) => v, "location"),
  client: /* @__PURE__ */ __name2((v) => v, "client"),
  completed_on: /* @__PURE__ */ __name2((v) => v, "completed_on"),
  scope: /* @__PURE__ */ __name2((v) => v, "scope"),
  description: /* @__PURE__ */ __name2((v) => v, "description"),
  capabilities: /* @__PURE__ */ __name2((v) => JSON.stringify(v ?? []), "capabilities"),
  images: /* @__PURE__ */ __name2((v) => JSON.stringify(v ?? []), "images"),
  status: /* @__PURE__ */ __name2((v) => v, "status")
};
...
__name2(rowToProperty, "rowToProperty");
...
__name(safeParseArray2, "safeParseArray2");
__name2(safeParseArray2, "safeParseArray");
...
var COLUMNS2 = {
  title: /* @__PURE__ */ __name2((v) => v, "title"),
  slug: /* @__PURE__ */ __name2((v) => slugify2(v), "slug"),
  listing_type: /* @__PURE__ */ __name2((v) => v, "listing_type"),
  property_type: /* @__PURE__ */ __name2((v) => v, "property_type"),
  price: /* @__PURE__ */ __name2((v) => Number(v), "price"),
  price_period: /* @__PURE__ */ __name2((v) => v, "price_period"),
  currency: /* @__PURE__ */ __name2((v) => v, "currency"),
  location: /* @__PURE__ */ __name2((v) => v, "location"),
  bedrooms: /* @__PURE__ */ __name2((v) => v === null ? null : Number(v), "bedrooms"),
  bathrooms: /* @__PURE__ */ __name2((v) => v === null ? null : Number(v), "bathrooms"),
  size_sqm: /* @__PURE__ */ __name2((v) => v === null ? null : Number(v), "size_sqm"),
  description: /* @__PURE__ */ __name2((v) => v, "description"),
  features: /* @__PURE__ */ __name2((v) => JSON.stringify(v ?? []), "features"),
  images: /* @__PURE__ */ __name2((v) => JSON.stringify(v ?? []), "images"),
  status: /* @__PURE__ */ __name2((v) => v, "status")
};
...
// .wrangler/tmp/bundle-boiovE/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-boiovE/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3850268391472088.js.map
